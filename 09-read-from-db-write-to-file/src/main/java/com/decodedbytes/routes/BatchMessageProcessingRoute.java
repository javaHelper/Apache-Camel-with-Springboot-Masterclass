...
public class BatchMessageProcessingRoute extends RouteBuilder {
    ...
    public void configure() throws Exception {
        from("timer:batch?period=1000")
                ...
                .toD("jpa:"+InboundNameAddress.class.getName()+"?nativeQuery=DELETE FROM NAME_ADDRESS " +
                        "where id = ${header.consumedId}&useExecuteUpdate=true")
                .end();
